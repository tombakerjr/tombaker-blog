/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 00b3cb736d2601f44db41d1846519598)
// Runtime types generated with workerd@1.20250803.0 2025-08-10 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		KVDATA: KVNamespace;
		D1DATA: D1Database;
		WORKER_SELF_REFERENCE: Fetcher /* tombaker-blog-workers */;
		ANALYTICS1: AnalyticsEngineDataset;
		ASSETS: Fetcher;
	}
}
